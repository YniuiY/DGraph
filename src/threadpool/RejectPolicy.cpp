#include "threadpool/RejectPolicy.hpp"
...
DiscardPolicy::DiscardPolicy() { cout << "construct DiscardPolicy\n"; }
...
AbortPolicy::AbortPolicy() { cout << "construct AbortPolicy\n"; }
...
CallerRunPolicy::CallerRunPolicy() { cout << "construct CallerRunPolicy\n"; }
